...
public class BodyAttackSkill implements ISkillFunction {
     ...
     *
     * Create one entity with the necessary componets to realize an attack
     * the attack happens only near to hero, the position of hero is the same position of attack
     *
     * @Entity who uses the attack
     *
     */
    public void execute(Entity entity) {
        ...
        new HitboxComponent(
            attack, new Point(0.25f, 0.25f), hitboxSize, collide, null);
