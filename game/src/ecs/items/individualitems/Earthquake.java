...
public class Earthquake extends ItemData implements IOnUse {
    ...
    public Earthquake() {
        super(
                ...
                AnimationBuilder.buildAnimation(
                        "objects/items/earthquake/earthquake_inventory.png"),
    ...
    /**
     * Gets a list of all entities in the level, checks if it has a HealthComponent, and if so,
     * deals 10 physical damage to them.
     *
    ...
    public void onUse(Entity e, ItemData item) {
        ...
        for (Entity entity : allEntities) {
            entity.getComponent(HealthComponent.class)
                    .ifPresent(
                            hc -> {
                                Damage dmg = new Damage(DMG, DamageType.PHYSICAL, null);
