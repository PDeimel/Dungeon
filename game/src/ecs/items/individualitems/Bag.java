...
public class Bag extends ItemData implements IOnCollect {
    ...
    /**
     * Once a bag has been collected, the items of the hero will be copied into a list, a bigger
     * inventory will be created for the hero and all of his current items are copied into that,
                ...
                .ifPresent(
                        ic -> {
                            ...
                            if (whoCollides.getClass() == Hero.class) {
                                ...
                                whoCollides.addComponent(
                                        new InventoryComponent(whoCollides, currSlots + SLOTS));
