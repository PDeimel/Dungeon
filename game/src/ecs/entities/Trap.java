...
public class Trap extends Entity {
    ...
    private Animation trapActive =
            AnimationBuilder.buildAnimation("character/trap.spikeTrap/spikeTrap_active.png");
    private Animation trapHidden =
            AnimationBuilder.buildAnimation("character/trap.spikeTrap/spikeTrap_inactive.png");
